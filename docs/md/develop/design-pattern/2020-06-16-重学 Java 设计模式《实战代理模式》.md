...
![代理模式，图片来自 refactoringguru.cn](res\2020-06-16-重学 Java 设计模式《实战代理模式》.md\85b36493-3656-4ed4-a08c-e5fc7cc71aac.jpg)
...
![场景模拟；实现mybatis-spring中代理类生成部分](res\2020-06-16-重学 Java 设计模式《实战代理模式》.md\f52d0f75-f8e0-4836-9a90-018e96113aff.jpg)
...
![代理模式中间件模型结构](res\2020-06-16-重学 Java 设计模式《实战代理模式》.md\d43e46c7-0be9-481e-a943-bff34ffb6e5b.jpg)
