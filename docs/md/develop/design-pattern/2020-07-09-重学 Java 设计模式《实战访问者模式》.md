...
![访问者模式，图片来自 refactoringguru.cn](res\2020-07-09-重学 Java 设计模式《实战访问者模式》.md\47a1b6ea-bbfe-4071-b202-1c31352f5650.jpg)
...
![美女吃冰激凌](res\2020-07-09-重学 Java 设计模式《实战访问者模式》.md\4d1c6f6d-24b6-4554-bc5f-ff0d137a0418.jpg)

说白了访问者模式的核心在于同一个事物不同视角下的访问信息不同，比如一个`美女`手里拿个`冰激凌`。小朋友会注意冰激凌，大朋友会找自己喜欢的地方观测敌情。

## 四、案例场景模拟

![场景模拟；校园中的学生和老师对于不同用户的访问视角](res\2020-07-09-重学 Java 设计模式《实战访问者模式》.md\f443f63a-831b-4d57-9708-482b695b2106.jpg)
...
![访问者模式模型结构](res\2020-07-09-重学 Java 设计模式《实战访问者模式》.md\0a36b5ae-d63a-4cef-aead-659314cc4348.jpg)
