...
3. 生成密钥(可以使用命令行生成，也可以直接在操作界面生成)
   ...
   ![](res\2019-12-07-发布Jar包到Maven中央仓库，为开发开源中间件做准备.md\2b678ece-fab2-4212-b553-0dda0f888eb4.jpg)
   2. 填写个人信息姓名和邮箱 并点击到 新建
   ![](res\2019-12-07-发布Jar包到Maven中央仓库，为开发开源中间件做准备.md\5ef37d1a-fd45-439f-9941-e2539f2f4934.jpg)
   3. 填写密钥密码
   ![](res\2019-12-07-发布Jar包到Maven中央仓库，为开发开源中间件做准备.md\a7be264e-1ae1-482b-90a9-ae208c3a86b4.jpg)
   4. 将公钥上传到目录服务{如果上传失败，则通过：设置(S)->配置Kleopatra(C)，修改 OpenPGP密钥服务器为：hkp://keyserver.ubuntu.com:80}
   ![](res\2019-12-07-发布Jar包到Maven中央仓库，为开发开源中间件做准备.md\fe660cd5-5aeb-4fc8-82b7-244401ef191b.jpg)

### 2. 工单系统帐号注册issues.sonatype

#### 1. 注册地址：https://issues.sonatype.org/secure/Signup!default.jspa
![](res\2019-12-07-发布Jar包到Maven中央仓库，为开发开源中间件做准备.md\f3f0be8f-1382-485b-a15a-ee4de43cd779.jpg)

#### 2. 创建工单
![](res\2019-12-07-发布Jar包到Maven中央仓库，为开发开源中间件做准备.md\c6361c28-8d30-4d7a-8233-f887cbdcc9ff.jpg)
...
#### 3. 配合人工审核
   ...
   1. 当创建完工单后，会收到信息反馈(国外与我们有时间差，半夜的时候他们审核的更快)；
	   ...
	   ```
	   ![](res\2019-12-07-发布Jar包到Maven中央仓库，为开发开源中间件做准备.md\67979476-c99c-488e-8d94-f8a31f820677.jpg)
   2. 配置域名验证签名；TXT 指向问题域：https://issues.sonatype.org/browse/OSSRH-53637
	   ![](res\2019-12-07-发布Jar包到Maven中央仓库，为开发开源中间件做准备.md\1a74366e-668e-448e-92ed-0fddbffe55b7.jpg)
   3. 在域名验证截图，回复到问题下，人工审核会进行验证处理
	   ![](res\2019-12-07-发布Jar包到Maven中央仓库，为开发开源中间件做准备.md\d3f75f0c-5b74-436d-9afa-7401ffe99d45.jpg)
   ...
   5. 接下来等待发布Jar包成功后，到这里回复并收到反馈，如下(证明你成功了！)；
	  ...
	  ![](res\2019-12-07-发布Jar包到Maven中央仓库，为开发开源中间件做准备.md\a1612192-173d-44c3-8608-0b509f6e1e65.jpg)
...
2. https://oss.sonatype.org 查看发布内容
   ![](res\2019-12-07-发布Jar包到Maven中央仓库，为开发开源中间件做准备.md\83d85712-3b1e-4668-93a1-61f9c70006a1.jpg)
3. 到上面"配合人工审核",按照说明提交发布成功信息，验证成功后会收到回复，如下；
   ```java
   Central sync is activated for org.itstack.middleware. After you successfully release, your component will be published to Central, typically within 10 minutes, though updates to search.maven.org can take up to two hours.
   ```
4. https://search.maven.org 搜索版本信息  
  ![](res\2019-12-07-发布Jar包到Maven中央仓库，为开发开源中间件做准备.md\16344dd9-2ca0-4b37-9c73-2d349d8fe4a7.jpg)
5. https://maven.aliyun.com 阿里云仓库同步较快，可以查看
  ![](res\2019-12-07-发布Jar包到Maven中央仓库，为开发开源中间件做准备.md\26019c63-0826-4dc8-8811-005c26cdbd1e.jpg)
