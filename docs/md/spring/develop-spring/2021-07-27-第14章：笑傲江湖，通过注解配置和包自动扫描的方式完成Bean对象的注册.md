...
![](res\2021-07-27-第14章：笑傲江湖，通过注解配置和包自动扫描的方式完成Bean对象的注册.md\58d60ef7-e1bd-4f04-835f-8b2f397bb928.jpg)
...
![图 14-2](res\2021-07-27-第14章：笑傲江湖，通过注解配置和包自动扫描的方式完成Bean对象的注册.md\51eedb59-f198-4d3d-bbbc-d8229d70b4b8.jpg)
