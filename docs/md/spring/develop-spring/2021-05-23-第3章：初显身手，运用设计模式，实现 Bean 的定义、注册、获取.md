...
![](res\2021-05-23-第3章：初显身手，运用设计模式，实现 Bean 的定义、注册、获取.md\11cb8af2-a26d-4387-bad4-97f168d34aa6.jpg)
...
![图 3-2](res\2021-05-23-第3章：初显身手，运用设计模式，实现 Bean 的定义、注册、获取.md\fccdfe88-431d-4c63-9716-19382d4b5164.jpg)
...
- 此外从调试的截图中也可以看到第二次获取单例对象，已经可以从内存中获取了，如图 3-3
	![图 3-3](res\2021-05-23-第3章：初显身手，运用设计模式，实现 Bean 的定义、注册、获取.md\1daddc16-21e9-4134-b79c-1db6821477bb.jpg)
