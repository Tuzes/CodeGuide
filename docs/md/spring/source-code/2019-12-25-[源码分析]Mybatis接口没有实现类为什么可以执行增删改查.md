...
![微信公众号：bugstack虫洞栈 & 初始化流程](res\2019-12-25-[源码分析]Mybatis接口没有实现类为什么可以执行增删改查.md\f21a76cb-b710-4e9a-9df5-213b7bf2e247.jpg)
...
![微信公众号：bugstack虫洞栈 & 动态代理过程](res\2019-12-25-[源码分析]Mybatis接口没有实现类为什么可以执行增删改查.md\3b00a86c-6256-4018-bc6b-6d469081b5c1.jpg)
...
![微信公众号：bugstack虫洞栈 & MapperScannerConfigurer类图](res\2019-12-25-[源码分析]Mybatis接口没有实现类为什么可以执行增删改查.md\e9ab6fb5-5914-4272-a422-4661e689fc9a.jpg)

执行流程如下；

![微信公众号：bugstack虫洞栈 & 执行流程图](res\2019-12-25-[源码分析]Mybatis接口没有实现类为什么可以执行增删改查.md\ce147685-25da-4bbe-b89e-31210220441b.jpg)
...
![微信公众号：bugstack虫洞栈 & MapperFactoryBean类图](res\2019-12-25-[源码分析]Mybatis接口没有实现类为什么可以执行增删改查.md\8a2fed8d-d0bd-4748-84b4-f352d395458a.jpg)
...
![微信公众号：bugstack虫洞栈 & SqlSessionFactoryBean初始化流程](res\2019-12-25-[源码分析]Mybatis接口没有实现类为什么可以执行增删改查.md\25774f2a-8007-4d20-a9a7-4d7b0eb7ad46.jpg)
