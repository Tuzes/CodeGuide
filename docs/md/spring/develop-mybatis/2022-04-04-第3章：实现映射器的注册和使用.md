...
![图 3-1 映射器的注册和使用](res\2022-04-04-第3章：实现映射器的注册和使用.md\a52d1b1b-d58c-4f1a-907c-cdfd4425304c.jpg)
...
![图 3-2 映射器标准定义实现关系](res\2022-04-04-第3章：实现映射器的注册和使用.md\5df46868-67a3-4f9d-a9ac-2f701f42ae12.jpg)
